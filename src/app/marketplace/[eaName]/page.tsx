              ...
              <div className="mb-4">
                ...
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div className="flex items-center gap-1">
                    {[...Array(5)].map((_, i) => (
                      <svg key={i} className={`w-5 h-5 ${i < Math.floor(eaDetails.rating) ? 'text-yellow-400' : 'text-gray-300'}`} fill="currentColor" viewBox="0 0 20 20">
                    ...
                    <span className="text-sm text-black/60 dark:text-white/60 ml-1">
                      {eaDetails.rating} ({eaDetails.reviews} reviews)
                    </span>
                  </div>
                </div>
              </div>
          ...
          <div className="lg:col-span-1">
            <div className="bg-white dark:bg-gray-900 rounded-xl border border-black/[.08] dark:border-white/[.145] p-6 sticky top-6">
              <div className="text-center mb-6">
                <div className="text-4xl font-bold mb-2">${eaDetails.price}</div>
