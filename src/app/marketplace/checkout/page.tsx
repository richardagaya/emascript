...
export default function CheckoutPage() {
  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center bg-gray-100 dark:bg-black/[.90] py-12">
      <div className="max-w-md w-full p-8 bg-white dark:bg-gray-900 shadow-2xl rounded-xl text-center border border-gray-100 dark:border-gray-800">
        <h2 className="text-2xl font-bold mb-2 text-gray-800 dark:text-gray-50">Checkout</h2>
        <p className="mb-4 text-gray-700 dark:text-gray-200">
          You are buying <span className="font-semibold">{botName}</span>.
        </p>
        <form className="flex flex-col gap-4 mb-8">
          ...
          <PhoneInput
            ...
            specialLabel=""
            inputProps={{ required: true, name: 'phone', autoComplete: 'tel', placeholder: 'Phone number' }}
            enableSearch
        ...
        <div className="flex flex-col gap-4">
          ...
          <button
            ...
            className="py-3 px-6 flex items-center justify-center gap-3 rounded-full bg-gradient-to-r from-blue-600 to-blue-700 text-white font-medium hover:from-blue-700 hover:to-blue-800 transition-all shadow-lg hover:shadow-xl disabled:opacity-50 disabled:cursor-not-allowed"
            disabled={!canProceed}
          >
            {isProcessing ? (
              <>
              ...
              <svg className="w-7 h-7" viewBox="0 0 512 512" fill="none" xmlns="http://www.w3.org/2000/svg">
                <rect width="512" height="512" rx="100" fill="white"/>
                <path d="M140 200c0-22 18-40 40-40h80c44 0 80 36 80 80s-36 80-80 80h-40v80h-80V200zm80 80h40c22 0 40-18 40-40s-18-40-40-40h-40v80z" fill="#1B3991"/>
                <path d="M140 200c0-22 18-40 40-40h80c44 0 80 36 80 80s-36 80-80 80h-40v80h-80V200z" fill="#1B3991"/>
              </svg>
              Pay with Pesapal
              </>
            )}
          ...
          <button
            ...
            className="py-3 px-6 flex items-center justify-center gap-3 rounded-full bg-gradient-to-r from-[#0070ba] to-[#003087] text-white font-medium hover:from-[#003087] hover:to-[#001f5b] transition-all shadow-lg hover:shadow-xl disabled:opacity-50 disabled:cursor-not-allowed"
            disabled={!canProceed}
          >
            {isProcessing ? (
              <>
              ...
              <>
              <svg className="w-7 h-7" viewBox="0 0 124 33" fill="none" xmlns="http://www.w3.org/2000/svg">
