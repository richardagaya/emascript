        ...
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {getAllEAs().map((bot) => {
            ...
            return (
              <div 
                key={bot.name} 
                className={`rounded-xl border border-black/[.08] dark:border-white/[.145] p-6 transition-shadow relative flex flex-col h-full ${
                  isUnderDevelopment 
              ...
              >
                ...
                <div className="mt-auto pt-2 flex items-center justify-between gap-3">
                  ...
                  <div className="flex flex-col sm:flex-row gap-2 w-full sm:w-auto justify-end">
                    <button
                      className={`w-full sm:w-auto px-4 py-2 text-sm rounded-md font-medium text-center ${
                        isUnderDevelopment
                    ...
                    <button
                      className={`w-full sm:w-auto px-4 py-2 text-sm border border-black/[.08] dark:border-white/[.145] rounded-md font-medium text-center ${
                        isUnderDevelopment
